...
if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/wt_doorman/class.tx_wtdoorman_removexss.php"])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/wt_doorman/class.tx_wtdoorman_removexss.php"]);
}
